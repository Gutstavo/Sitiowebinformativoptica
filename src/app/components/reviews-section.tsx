      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-gray-50 rounded-2xl p-12 shadow-lg">
          ...
          <p className="text-2xl mb-8 text-gray-700">
            Calificación de <span style={{ color: 'var(--egyptian-blue)' }}>5 estrellas</span> basada en cientos de reseñas verificadas
          </p>
          ...
          <Button size="lg" asChild style={{ backgroundColor: 'var(--egyptian-blue)' } as React.CSSProperties} className="hover:opacity-90">
